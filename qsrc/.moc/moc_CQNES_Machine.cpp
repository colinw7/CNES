...
void CNES::QMachine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QMachine *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QMachine::*)(ushort , ushort );
...
QT_INIT_METAOBJECT const QMetaObject CNES::QMachine::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_CNES__QMachine.data,
    qt_meta_data_CNES__QMachine,
    qt_static_metacall,
    nullptr,
    nullptr
} };
